...
<Head
	title="[Guide] Flash Custom Recovery"
	description="Guide to flash a Custom Recovery on Motorola One Fusion | Astro"
	ogUrl="https://syoker.vercel.app/blog/motorolaonefusion/guide-flash-custom-recovery"
	ogTitle="[Guide] Flash Custom Recovery"
	ogDescription="Guide to flash a Custom Recovery on Motorola One Fusion | Astro"
...
- ### **Bootloader unlocked**
    ...
    Link of the guide - [[Guide] Unlock bootloader](https://syoker.github.io/blog/motorolaonefusion/guide-unlock-bootloader/)
...
- ### **Custom Recovery**
    ...
    Link of TWRP - [GitHub](https://github.com/sdm710-motorola/android_device_motorola_astro_twrp/releases) (credits to [Uotlaf](https://github.com/uotlaf)) - Functional on Android 12 with the latest version.
    
    Link of OrangeFox - [GitHub](https://github.com/sdm710-motorola/android_device_motorola_astro_ofrp/releases) (credits to [Uotlaf](https://github.com/uotlaf)) - Not functional on Android 12.
    

## **Procedure for flashing the Custom Recovery**
...
5. Once inside the bootloader, flash the recovery on both partitions of the device with:
...
6. Now reboot to recovery with `fastboot reboot recovery` and you are in recovery.

Now, make a backup of the EFS, Modem and Persist folders and save it on a micro SD card or on the computer, as it will be useful if for some reason you lose the IMEI.

![IMEI Backup](/img/guide-imeibackup.png)
