...
The next steps will be on [this](https://motorola-global-portal.custhelp.com/app/standalone%2Fbootloader%2Funlock-your-device-b) Motorola page, but I'll explain it anyway.
...
7. Paste the code you made into the text field on the [Motorola page](https://motorola-global-portal.custhelp.com/app/standalone%2Fbootloader%2Funlock-your-device-b) that says "MAKE SURE YOUR DEVICE IS UNLOCKABLE".
